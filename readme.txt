=== WP Login Zap - Send User Login Information To Zapier ===
Contributors: sanzeeb3
Tags: zapier, login, login activity, send data,
...
Do anything whenever user(s) logs into your site, with Zapier. Send data to Zapier ~ do anything with Zapier.
...
= 1.0.1 - 10/17/2019 =
* Feature - Get User IP and Browser Information
